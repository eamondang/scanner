      ...
      return (
        <>
          <div className="content">
            ...
            <h2>Claimed!</h2>
            <img src="/img/green-check.png" alt="green check" width="50" height="60" className="img_center"></img>
          </div>
        </>
      );
      ...
      return (
        <>
          <div className="content">
            ...
            <h4>To re-enter password, refresh the page</h4>
            <img src="/img/red-x.png" alt="red x" width="50" height="60" className="img_center"></img>
          </div>
        </>
      );
    default:
